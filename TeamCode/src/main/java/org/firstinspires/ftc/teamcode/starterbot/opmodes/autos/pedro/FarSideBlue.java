...
public class FarSideBlue extends PedroBaseAuto {
    ...
    private void buildEffectivePoses() {
        ...
        shootPreloadPose = shootPreloadPoseBlue;
        pickUpMiddlePose = pickUpMiddlePoseBlue;
        intakeMiddlePose = intakeMiddlePoseBlue;
        openGatePose     = openGatePoseBlue;
        shootMiddlePose  = shootMiddlePoseBlue;
        pickUpTopPose    = pickUpTopPoseBlue;
        intakeTopPose    = intakeTopPoseBlue;
        shootTopPose     = shootTopPoseBlue;
        pickUpBottomPose = pickUpBottomPoseBlue;
        intakeBottomPose = intakeBottomPoseBlue;
        shootBottomPose  = shootBottomPoseBlue;
        parkPose         = parkPoseBlue;

        // Control points
        cpPickUpMiddle1  = cpPickUpMiddle1Blue;
        cpOpenGate1      = cpOpenGate1Blue;
        cpOpenGate2      = cpOpenGate2Blue;
        cpShootMiddle1   = cpShootMiddle1Blue;
        cpShootTop1      = cpShootTop1Blue;
        cpPickUpBottom1  = cpPickUpBottom1Blue;
        cpShootBottom1   = cpShootBottom1Blue;
        cpPark1          = cpPark1Blue;
